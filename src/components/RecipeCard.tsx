...
export function RecipeCard({ recipe, showDescription = false, }: RecipeCardProps) {
    ...
    return (
        <>
            <div key={recipe?.id} className="group relative h-100 rounded-md overflow-hidden shadow-md hover:shadow-lg transition-all duration-500 cursor-pointer bg-white">
                ...
                {/* Botão*/}
                <div className="absolute bottom-5.5 right-6 opacity-100 xl:opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 xl:translate-y-4 group-hover:translate-y-0 group-focus-within:translate-y-0 transition-all duration-500">
                    <Link
